...
class SyncIncomingOdooInvoices extends Command
{
    protected $signature = 'sync:incoming-odoo-invoices';
    protected $description = 'Sincroniza facturas entrantes desde Odoo: añade posted, elimina cancel';
