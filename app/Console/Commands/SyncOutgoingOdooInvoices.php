...
class SyncOutgoingOdooInvoices extends Command
{
    protected $signature = 'sync:outgoing-odoo-invoices';
    protected $description = 'Sincroniza facturas salientes desde Odoo: añade posted, elimina cancel';
    ...
    {
        $this->info('Iniciando sincronización de facturas salientes con Odoo...');

        $odooInvoices = $this->odoo->getOutgoingInvoices();
        ...
        $this->output->progressStart(count($odooInvoices));
